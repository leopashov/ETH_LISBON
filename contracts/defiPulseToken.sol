// DeFi Pulse token - use as example for some functions

// also reference: https://github.com/victoryeo/defi_indexfund/tree/master/src/contracts
...
library Position {
    ...
    function calculateDefaultEditPositionUnit(
        ...
        if (_preTotalNotional >= _postTotalNotional) {
            uint256 unitsToSub = _preTotalNotional
                .sub(_postTotalNotional)
                .preciseDivCeil(_setTokenSupply);
            ...
            uint256 unitsToAdd = _postTotalNotional
                .sub(_preTotalNotional)
    ...
    */
    ...
    function removeExternalPositionModule(
        ...
        componentPositions[_component]
            .externalPositionModules = _externalPositionModules(_component)
            .remove(_positionModule);
